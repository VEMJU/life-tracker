  ...
  const Academics = (() => {
    ...
    function readiness() {
      ...
      return [
        ...
        { id: 'prior', label: 'Prior school transcript',
          state: 'todo',
          note: 'The fall-2023 school behind your CR* transfer credits',
          due: '2026-08-08',
          hint: 'Slowest paper you own — nobody there has thought about you in three years.' },
